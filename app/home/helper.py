...
#     total_teams = Team.query.filter_by(league_name=league_name)
#     print("horseradish")
#     return True
...
#
    ...
    while teamindex < number_of_teams:
        ...
        ranking_entry = Rankings.query.filter_by(league_name=league_name, team=current_team)
        print("RANKENTRY", ranking_entry)
