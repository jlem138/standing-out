...
Revision ID: 52b1786fb2e4
Revises: 
Create Date: 2018-12-01 22:56:44.070681
...
def upgrade():
    ...
    op.create_table('update_leagues',
    sa.Column('league_type', sa.String(length=200), nullable=True),
    sa.Column('update_type', sa.String(length=60), nullable=True),
    sa.ForeignKeyConstraint(['league_type'], ['leagues.league_name'], ),
    sa.ForeignKeyConstraint(['update_type'], ['updates.username'], )
    )
